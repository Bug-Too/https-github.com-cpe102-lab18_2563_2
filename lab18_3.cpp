...
student * findstudent(vector<student> &allstudents,int key){ //There is something wrong in this line. change to float
...
int main(){
	...
	while(getline(student_file,textline)){
		...
		sscanf(textline.c_str(),fomat,s.name,&s.id,&s.gender,&s.gpa);
